  ...
  return knex('equipment').truncate()
    .then(function () {
      ...
      return knex('equipment').insert([
        {equipment_name: 'camera1', equipment_description: 'this is a test description for equipment 1', owner_id: 2, renter_id: null},
        {equipment_name: 'VCR2', equipment_description: 'this is a test description for equipment 2', owner_id: 2, renter_id: null},
